...
if lang_choice == "繁體中文":
    try:
        ...
        # If it fails, print why (likely folder structure)
...
wordbase_option = st.selectbox(
    _("Choose Wordbase"),
    (("唐詩三百首 - Three Hundred Tang Poems"), ("西遊記 - Journey to the West"), ("不同意罷免留言 - Anti Recall Comments"), ("同意罷免留言 - Pro Recall Comments"), ("不同意罷免雜志 - Anti Recall Magazine"))
)
